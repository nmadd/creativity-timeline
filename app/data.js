export default [
  {
    text: [`In late 2007 I started hosting a radio show at my campus radio station. I was excited because they were giving me a lot of creative freedom. You could basically play whatever you liked, as long as you had some sort of theme, and as long as you didn't play anything you'd normally hear on the radio.`,

    `I perhaps took that a little too literally and decided to do a show called Campfire Singalongs, which only played experimental electronic music that didn't have any words. I also lived right next to the radio station, so I agreed to take any time slot available. I ended up with the primetime slot of Wednesday nights, from 11 PM - 1 AM.`,

  `Needless to say, I did not have many listeners. But I loved the experience of putting together a show, creating a connecting theme and story, and putting it out there for anybody who cared.`],
    year: 2007,
    path: 'post1'
  },
  {
    text: [`That experience began to pay off when, two years later, I suddenly became an entrepreneur.`,
  ...
  },
  {
    text:[
    `
    FratMusic began as a simple playlist. I would listen to the music that was being played on campus, scour the internet for good remixes and mashups of those songs, and add them to the site.`,
  ...
  {
    text: [`For the first few years, I led product, branding, and content for our website. But then, with the fast rise of the iPhone, we suddenly had a whole new market: smartphone apps.`,

    `Over the course of about a year and a half, I led teams of designers and developers from initial concepts through finished products for both iOS and Android apps. Since we already had an established web presence, we decided to sell our apps, instead of releasing them for free. We ended up selling over 100,000 of them, which financed us over the next couple years.
    `],
    year: 2012,
    path: 'post4'
  },
  ...
  },
  {
    text: [`After attending a four-month coding school in Manhattan, I stumbled upon a small, non-profit coding school in Queens, NY that was focusing on teaching coding to underserved populations.
      I was immediately drawn in by their goal.`,
    ` Soon after, I began working as an instructor at Coalition for Queens, where I lead daily lessons in web development and computer science for a diverse group of students from a wide variety of backgrounds.
    It's been incredibly fulfilling to get to know the students on a personal level and to watch them grow from week to week and month to month.
    I've also gained experience in everything from building the overall arch of our curriculum,
    to managing the dynamics of a classroom,
    to learning how to build a non-profit. `],
    year: 2016,
    path: 'post7'
  },
  {
